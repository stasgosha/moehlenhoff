				...
				<div class="footer-inner">
					...
					<div class="footer-block">
						<ul class="footer-info-list">
							<li>2015 - <?= date('Y') ?> <br>Все права защищены</li>
							<li>105187, Москва, <br>ул. Вольная д. 39</li>
							<li>
								<a href="tel:+74957837000">+7 (495) 783-70-00</a><br>
								<a href="mailto:bataev@syskon.ru">bataev@syskon.ru</a>
							</li>
						</ul>
					</div>
					<div class="footer-block">
		...
		<div class="panel-inner">
			<ul class="panel-nav">
				<li class="menu-item-has-children">
					...
					<ul class="sub-menu">
						<li><a href="convectors.php">Конвекторы</a></li>
			...
			<div class="panel-content">
				<p>105187, Москва, ул. Вольная д. 39 <br><a href="tel:+74957837000">+7 (495) 783-70-00</a> <br><a href="mailto:bataev@syskon.ru">bataev@syskon.ru</a></p>
			</div>
		</div>
	</nav>
